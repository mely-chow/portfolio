...
function Header() {
  ...
  return (
    <div className="fixed top-0 left-0 z-50 w-full bg-black/20 px-2 py-2 backdrop-blur-md sm:px-6 sm:py-6">
      <div className="mx-auto flex w-full max-w-3xl items-center gap-1.5 rounded-xl border border-white/10 bg-[#0b0833]/60 p-1.5 sm:ml-auto sm:mr-0 sm:w-auto sm:max-w-none sm:justify-end sm:gap-5 sm:rounded-none sm:border-0 sm:bg-transparent sm:p-0">
